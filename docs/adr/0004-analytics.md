...
**Planned (not built yet):** Monday **weekly digest** via Vercel Cron + Web Analytics API + Neon aggregate counts + Resend. Mailchimp attribution via UTM links (not a Vercel short-link product). See Inkar brief §5.
