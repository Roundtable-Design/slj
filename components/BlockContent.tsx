    ...
    >
      ...
      */}
      ...
      <button
        ...
        className={`absolute z-10 flex items-center justify-center rounded border border-transparent bg-[var(--slj-surface)] text-[var(--slj-text-muted)] transition-colors hover:border-[var(--slj-border)] hover:text-[var(--slj-text)] focus-visible:border-[var(--slj-border)] focus-visible:text-[var(--slj-text)] xl:left-full xl:right-auto xl:ml-2 xl:opacity-0 xl:group-hover/block:opacity-100 xl:group-focus-within/block:opacity-100 ${
          dense
